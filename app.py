# 
# app.py — VERSÃO CORRIGIDA E ESTABILIZADA
# Interface Principal do Sistema de Triagem Canabinoide TEA
# Data: 31 de março de 2026
# Correções: Indentação consistente (4 espaços), remoção de ranges de idade, layout Seção 2 equilibrado,
#            Seção 11 (consentimento) corrigida, duplicatas removidas, sintaxe limpa.
# 
...
with col4:
    ...
    # SEÇÃO 4: DESENVOLVIMENTO (RANGE DE IDADE REMOVIDO)
    ...
    # SEÇÃO 11: CONSENTIMENTO (CORRIGIDA)
...
# 
# PROCESSAMENTO DO FORMULÁRIO (DUPLICATAS REMOVIDAS)
# 
